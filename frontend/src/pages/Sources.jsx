...
const SOURCES = [
  ...
  },
  {
    ...
    name:      'QGIS',
    family:    'Open-Source GIS Platform',
    what:      'Free and open-source desktop GIS used for AOI polygon creation, geospatial data preparation, and visualization of EO outputs — underpins the HydroTwin region boundaries and watershed analysis.',
    cadence:   'Open-source tool',
    href:      'https://qgis.org/',
  },
  {
    Icon:      ArrowPathIcon,
          ...
          {SOURCES.map(s => (
            ...
            >
              <div className="flex items-start gap-3">
                <s.Icon className={`w-6 h-6 flex-shrink-0 ${s.iconColor}`} aria-hidden="true" />
